...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveItemRequest(long requesterId, ItemRequestDtoIn itemRequestDtoIn) {
        return post("", requesterId, itemRequestDtoIn);
    }

    public ResponseEntity<Object> getAllItemRequestByRequesterId(long requesterId) {
